...
extension UIViewController {
    ...
    func confirmationAlert(title: String, message: String, confirmTitle: String, style: UIAlertAction.Style = .destructive, confirmAction: @escaping () -> Void) {
        ...
        let cancelAction = UIAlertAction(title: "Alert", style: .cancel) { action -> Void in
    ...
    func alertWithOkCancel(message: String?, title: String? = "Alert", okTitle: String? = "OK", style: UIAlertController.Style? = .alert, cancelTitle: String? = "Cancel", OkStyle: UIAlertAction.Style = .default, cancelStyle: UIAlertAction.Style = .default, okAction: (()->())? = nil, cancelAction: (()->())? = nil) {
